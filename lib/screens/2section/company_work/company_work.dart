...
//         // حساب إجمالي القيمة لهذا التاريخ
...
//       columnWidths: const {
//         0: pdfLib.FlexColumnWidth(1.5), // القيمة
//         1: pdfLib.FlexColumnWidth(1), // التاريخ
//         2: pdfLib.FlexColumnWidth(1), // المسلسل
//       },
//       children: [
//         // رأس الجدول
//         pdfLib.TableRow(
...
//           (row) => pdfLib.TableRow(
//             children: [
//               _kartaTableCell(_formatCurrencyForPDF(row['value'])),
...
//             _kartaTableCell(
//               rows
//                   .fold<double>(0.0, (sum, row) => sum + row['value'])
//                   .toStringAsFixed(2),
//               isTotal: true,
//             ),
...
//   // ================================
//   // توقيعات مطالبة الكارتات
//   // ================================
//   pdfLib.Widget _kartaRequestSignatures() {
//     return pdfLib.Column(
//       children: [
//         pdfLib.Divider(),
//         pdfLib.SizedBox(height: 20),
...
//                 pdfLib.Text(
//                   'توقيع مندوب الشركة',
//                   style: pdfLib.TextStyle(font: _arabicFont, fontSize: 10),
//                 ),
//                 pdfLib.Text(
//                   '......................',
//                   style: pdfLib.TextStyle(font: _arabicFont, fontSize: 10),
