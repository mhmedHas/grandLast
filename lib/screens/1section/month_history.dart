...
// //   // ====================================================
// //   // دالة تعديل الشغل اليومي (محدثة مع التاريخ)
// //   // ====================================================
...
// //     // متغير التاريخ
// //     DateTime selectedDate = dailyWork.date;

// //     // متغيرات موقع الشركة
// //     String? _selectedLocationId = dailyWork.companyLocationId;
// //     String? _selectedLocationName = dailyWork.companyLocationName;
// //     List<Map<String, dynamic>> _companyLocations = [];

// //     // دالة لتحميل مواقع الشركة
...
// //           return {
// //             'id': '${dailyWork.companyId}_${locations.indexOf(location)}',
...
// //             // تحميل مواقع الشركة عند فتح النافذة
// //             WidgetsBinding.instance.addPostFrameCallback((_) {
// //               if (_companyLocations.isEmpty) {
// //                 _loadCompanyLocations().then((_) {
// //                   if (!_isDisposed) {
// //                     setState(() {});
// //                   }
// //                 });
...
// //                               _selectedLocationId,
// //                               _selectedLocationName,
// //                               selectedDate, // تمرير التاريخ الجديد
// //                               isMobile,
// //                             );
// //                           },
// //                         ),
...
// //   // ====================================================
// //   // دالة جديدة لبناء حقل التاريخ في التعديل
// //   // ====================================================
...
// //   // ====================================================
// //   // دالة لبناء حقل موقع الشركة
// //   // ====================================================
// //   Widget _buildCompanyLocationField(
// //     String label,
// //     String hint,
// //     String? selectedLocationId,
// //     String? selectedLocationName,
// //     List<Map<String, dynamic>> companyLocations,
// //     bool isMobile, {
...
// //                 Expanded(
// //                   child: Text(
// //                     selectedLocationName ?? hint,
// //                     style: TextStyle(
// //                       fontSize: isMobile ? 14 : 16,
// //                       color: selectedLocationName != null
// //                           ? Colors.black
// //                           : Colors.grey,
// //                     ),
// //                   ),
...
// //   // ====================================================
// //   // نافذة اختيار موقع الشركة
// //   // ====================================================
// //   void _showCompanyLocationsDialog(
// //     bool isMobile,
// //     List<Map<String, dynamic>> companyLocations,
// //     String? selectedLocationId,
...
// //               ),
// //               Expanded(
// //                 child: companyLocations.isEmpty
// //                     ? Center(
// //                         child: Padding(
// //                           padding: const EdgeInsets.all(16),
// //                           child: Text(
...
// //                     : ListView.builder(
// //                         shrinkWrap: true,
// //                         itemCount: companyLocations.length + 1,
// //                         itemBuilder: (context, index) {
// //                           if (index == 0) {
// //                             return ListTile(
...
// //                           final location = companyLocations[index - 1];
// //                           return ListTile(
// //                             leading: Icon(
// //                               Icons.location_on,
...
// //   // ====================================================
// //   // نافذة تغيير عرض السعر مع البحث والاقتراحات (محدثة مع التاريخ)
// //   // ====================================================
...
// //   // ====================================================
// //   // دالة تحديث النقلة بعرض سعر جديد (محدثة مع التاريخ)
// //   // ====================================================
...
// //     DateTime newDate, // التاريخ الجديد
// //   ) async {
// //     try {
...
// //         'date': Timestamp.fromDate(newDate), // تحديث التاريخ
...
// //   // ====================================================
// //   // دالة تحديث سجلات السائقين بعرض سعر جديد (محدثة مع التاريخ)
// //   // ====================================================
...
// //   // ====================================================
// //   // دالة تحديث الشغل اليومي (محدثة مع التاريخ)
// //   // ====================================================
...
// //       // 3. تحديث سجلات السائقين
// //       if (driverDocs.docs.isNotEmpty) {
// //         final batch = _firestore.batch();

// //         for (final doc in driverDocs.docs) {
// //           batch.update(doc.reference, {
// //             'driverName': driverName.trim(),
// //             'loadingLocation': loadingLocation.trim(),
// //             'unloadingLocation': unloadingLocation.trim(),
...
// //   // ====================================================
// //   // دالة حذف الشغل اليومي (محدثة لتحذف من الاتنين)
// //   // ====================================================
...
// //                 style: const TextStyle(color: Colors.grey),
// //               ),
// //               if (dailyWork.companyLocationName != null &&
// //                   dailyWork.companyLocationName!.isNotEmpty)
// //                 Text(
// //                   'موقع الشركة: ${dailyWork.companyLocationName}',
// //                   style: TextStyle(
...
// //                     Expanded(
// //                       child: Text(
// //                         'سيتم حذف النقلة من السجل الشهري ومن سجلات السائقين نهائياً',
// //                         style: TextStyle(
// //                           color: Colors.red[700],
// //                           fontSize: isMobile ? 11 : 12,
// //                           fontWeight: FontWeight.bold,
...
// //   // ====================================================
// //   // دالة تأكيد الحذف (محدثة لتحذف من الاتنين)
// //   // ====================================================
// //   Future<void> _confirmDeleteDailyWork(DailyWork dailyWork) async {
// //     try {
// //       // البحث عن سجلات السائقين المرتبطة
// //       final driverDocs = await _firestore
// //           .collection('drivers')
// //           .where('dailyWorkId', isEqualTo: dailyWork.id)
// //           .get();

// //       // استخدام Batch لضمان تنفيذ جميع العمليات معاً أو عدم تنفيذ أي منها
// //       final batch = _firestore.batch();

// //       // 1. حذف من dailyWork
// //       batch.delete(_firestore.collection('dailyWork').doc(dailyWork.id));

// //       // 2. حذف كل سجلات السائقين المرتبطة
...
// //       // إظهار رسالة نجاح
// //       if (mounted && !_isDisposed) {
// //         _showSuccess('تم حذف النقلة وجميع سجلات السائقين المرتبطة بنجاح');
// //       }
// //     } catch (e) {
...
// //               child: Table(
// //                 columnWidths: {
// //                   0: FixedColumnWidth(isMobile ? 40 : 50), // م
// //                   1: FixedColumnWidth(isMobile ? 80 : 100), // التاريخ
// //                   2: FixedColumnWidth(isMobile ? 110 : 120), // اسم السائق
// //                   3: FixedColumnWidth(isMobile ? 110 : 120), // موقع الشركة
// //                   4: FixedColumnWidth(isMobile ? 120 : 120), // مكان التحميل
// //                   5: FixedColumnWidth(isMobile ? 120 : 120), // مكان التعتيق
// //                   6: FixedColumnWidth(isMobile ? 120 : 120), // مطابقه نولون
// //                   7: FixedColumnWidth(isMobile ? 60 : 80), // TR
// //                   8: FixedColumnWidth(isMobile ? 90 : 110), // العهدة
// //                   9: FixedColumnWidth(isMobile ? 90 : 110), // الكارتة
// //                   10: FixedColumnWidth(isMobile ? 110 : 160), // ملاحظات
// //                   11: FixedColumnWidth(isMobile ? 160 : 160), // الإجراءات
// //                 },
...
// //                       _TableCellHeader('موقع الشركة', isMobile),
...
// //       await _updateDriversHolidayOrOvernight(
// //         dailyWork,
// //         isHoliday,
// //         companyAmount,
// //         wheelAmount,
...
// //   // دالة تحديث drivers collection للعطلة والمبيت
// //   Future<void> _updateDriversHolidayOrOvernight(
// //     DailyWork dailyWork,
// //     bool isHoliday,
// //     double companyAmount,
// //     double wheelAmount,
...
//   // ====================================================
//   // دالة تعديل الشغل اليومي (محدثة مع نوع العربية)
//   // ====================================================
//   void _editDailyWork(DailyWork dailyWork, String companyName, bool isMobile) {
//     // Controllers للحقول
//     final driverNameController = TextEditingController(
...
//     // حقل نوع العربية (جديد)
//     final vehicleTypeController = TextEditingController(
//       text: dailyWork.selectedVehicleType ?? '',
//     );
...
//                               trController.text,
//                               notesController.text,
//                               vehicleTypeController.text, // إضافة نوع العربية
//                               _selectedLocationId,
//                               _selectedLocationName,
//                               selectedDate, // تمرير التاريخ الجديد
//                               isMobile,
...
//   // ====================================================
//   // نافذة تغيير عرض السعر مع البحث والاقتراحات (محدثة مع نوع العربية والتاريخ)
//   // ====================================================
//   void _showChangePriceOfferDialog(
//     BuildContext context,
//     DailyWork dailyWork,
...
//     String tr,
//     String notes,
//     String vehicleType, // إضافة نوع العربية
//     String? companyLocationId,
//     String? companyLocationName,
//     DateTime selectedDate, // التاريخ المحدد
//     bool isMobile,
...
//   // ====================================================
//   // دالة تحديث النقلة بعرض سعر جديد (محدثة مع نوع العربية والتاريخ)
//   // ====================================================
//   Future<void> _updateDailyWorkWithNewPrice(
//     DailyWork dailyWork,
//     String driverName,
...
//         'tr': tr.trim(),
//         'selectedNotes': notes.trim(),
//         'selectedVehicleType': vehicleType.trim(), // تحديث نوع العربية
//         'selectedRoute': newSelectedRoute,
//         'selectedPrice': newPrice,
//         'wheelNolon': newWheelNolon,
//         'selectedVehicleType': newVehicleType,
...
//   // ====================================================
//   // دالة تحديث سجلات السائقين بعرض سعر جديد (محدثة مع نوع العربية والتاريخ)
//   // ====================================================
//   Future<void> _updateDriversWithNewPrice(
//     DailyWork dailyWork,
//     String driverName,
...
//   // ====================================================
//   // دالة تحديث الشغل اليومي (محدثة مع نوع العربية والتاريخ)
//   // ====================================================
//   Future<void> _updateDailyWork(
//     DailyWork dailyWork,
//     String driverName,
...
//                 style: const TextStyle(color: Colors.grey),
//               ),
//               if (dailyWork.selectedVehicleType != null &&
//                   dailyWork.selectedVehicleType!.isNotEmpty)
//                 Text(
//                   'نوع العربية: ${dailyWork.selectedVehicleType}',
//                   style: TextStyle(
//                     color: Colors.blue[700],
//                     fontWeight: FontWeight.bold,
//                   ),
...
//                     isMobile ? 120 : 130,
//                   ), // نوع العربية (جديد)
//                   5: FixedColumnWidth(isMobile ? 120 : 120), // مكان التحميل
//                   6: FixedColumnWidth(isMobile ? 120 : 120), // مكان التعتيق
//                   7: FixedColumnWidth(isMobile ? 120 : 120), // مطابقه نولون
//                   8: FixedColumnWidth(isMobile ? 60 : 80), // TR
//                   9: FixedColumnWidth(isMobile ? 90 : 110), // العهدة
//                   10: FixedColumnWidth(isMobile ? 90 : 110), // الكارتة
//                   11: FixedColumnWidth(isMobile ? 110 : 160), // ملاحظات
//                   12: FixedColumnWidth(isMobile ? 200 : 200), // الإجراءات
//                 },
...
//                       _TableCellHeader('اسم السائق', isMobile),
//                       _TableCellHeader('موقع الشركة', isMobile),
//                       _TableCellHeader('نوع العربية', isMobile), // عمود جديد
//                       _TableCellHeader('مكان التحميل', isMobile),
//                       _TableCellHeader('مكان التعتيق', isMobile),
//                       _TableCellHeader('مطابقه نولون', isMobile),
//                       _TableCellHeader('TR', isMobile),
...
//                         // عمود نوع العربية (جديد)
//                         _TableCellBody(
//                           dailyWork.selectedVehicleType ?? '',
//                           isMobile,
//                           textStyle: TextStyle(
//                             fontWeight: FontWeight.bold,
//                             color: Colors.blue[700],
...
class _MonthlyRecordPageState extends State<MonthlyRecordPage> {
            ...
            child: SingleChildScrollView(
              ...
              child: Table(
                columnWidths: {
                  ...
                  2: FixedColumnWidth(isMobile ? 110 : 120), // اسم السائق
                  3: FixedColumnWidth(isMobile ? 110 : 120), // موقع الشركة
                  4: FixedColumnWidth(isMobile ? 120 : 130), // نوع العربية
                  5: FixedColumnWidth(isMobile ? 120 : 120), // مكان التحميل
                  6: FixedColumnWidth(isMobile ? 120 : 120), // مكان التعتيق
                  7: FixedColumnWidth(isMobile ? 120 : 120), // مطابقه نولون
                  8: FixedColumnWidth(isMobile ? 60 : 80), // TR
                  ...
                  10: FixedColumnWidth(isMobile ? 90 : 110), // الكارتة
                  11: FixedColumnWidth(isMobile ? 110 : 160), // ملاحظات
                  12: FixedColumnWidth(isMobile ? 220 : 240), // الإجراءات
                },
                border: TableBorder.all(
                  color: const Color(0xFF3498DB),
                  width: 1,
                ...
                children: [
                  ...
                  TableRow(
                    ...
                    children: [
                      ...
                      _TableCellHeader('اسم السائق', isMobile),
                      _TableCellHeader('موقع الشركة', isMobile),
                      _TableCellHeader('نوع العربية', isMobile),
                      _TableCellHeader('مكان التحميل', isMobile),
                      _TableCellHeader('مكان التعتيق', isMobile),
                      _TableCellHeader('مطابقه نولون', isMobile),
                      _TableCellHeader('TR', isMobile),
                      ...
                      children: [
                        ...
                        _TableCellActionsWithAll(
                          ...
                          onAddOvernight: () =>
                              _addOvernight(dailyWork, companyName, isMobile),
                          onAddWeight: () =>
                              _showAddWeightDialog(dailyWork, isMobile),
                          onAddBroz: () =>
                              _showAddBrozDialog(dailyWork, isMobile),
                        ),
                      ],
                    );
                  }),
  ...
  // ====================================================
  // دالة إضافة وزن (تعديل حسب الطلب)
  // ====================================================
  void _showAddWeightDialog(DailyWork dailyWork, bool isMobile) {
            ...
            return AlertDialog(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 6),
                          Text('• نوع العربية: $selectedVehicleType'),
                          Text('• قيمة الوزن: ${weightController.text} ج'),
                          Text(
                            '• نولون الشركة الجديد: ${(dailyWork.selectedPrice ?? 0) + (double.tryParse(weightController.text) ?? 0)} ج',
                          ),
                          Text(
                            '• اسم العربية: $selectedVehicleType',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.green[700],
                            ),
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (selectedVehicleType == null) {
                      _showError('يرجى اختيار نوع العربية');
                      return;
                    }
                    if (weightController.text.isEmpty) {
                      _showError('يرجى إدخال قيمة الوزن');
                      return;
                    }
                    ...
                    if (weightValue <= 0) {
                      _showError('قيمة الوزن يجب أن تكون أكبر من صفر');
                      return;
                    }

                    await _updateWeightOnly(
                      dailyWork,
                      selectedVehicleType!,
                      weightValue,
                    );
  ...
  // ====================================================
  // دالة تحديث الوزن فقط (نولون الشركة + اسم العربية)
  // ====================================================
  Future<void> _updateWeightOnly(
    DailyWork dailyWork,
    String newVehicleType,
    double weightValue,
  ) async {
    try {
      final currentPrice = dailyWork.selectedPrice ?? 0.0;
      final newPrice = currentPrice + weightValue;

      // 1. تحديث في collection "dailyWork" - فقط نولون الشركة ونوع العربية
      await _firestore.collection('dailyWork').doc(dailyWork.id).update({
        'selectedVehicleType': newVehicleType,
        'selectedPrice': newPrice,
        'nolon': newPrice,
      ...
      // 2. تحديث سجلات السائقين المرتبطة - فقط نولون الشركة ونوع العربية
      final driverDocs = await _firestore
          .collection('drivers')
          .where('dailyWorkId', isEqualTo: dailyWork.id)
          .get();
      ...
      if (driverDocs.docs.isNotEmpty) {
        ...
        for (final doc in driverDocs.docs) {
          batch.update(doc.reference, {
            ...
            'nolon': newPrice,
            'weightValue': weightValue,
            'remainingAmount': FieldValue.increment(weightValue),
            'updatedAt': Timestamp.now(),
          });
        }
      ...
      if (mounted && !_isDisposed) {
        _showSuccess(
          'تم إضافة وزن بقيمة $weightValue ج\nنوع العربية: $newVehicleType',
        );
      }
    } catch (e) {
      print('خطأ في تحديث الوزن: $e');
      if (mounted && !_isDisposed) {
        _showError('خطأ في إضافة الوزن: $e');
      }
    }
  }

  // ====================================================
  // دالة إضافة بروز (تعديل حسب الطلب)
  // ====================================================
  void _showAddBrozDialog(DailyWork dailyWork, bool isMobile) {
    final brozController = TextEditingController();
    ...
    showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            final brozValue = double.tryParse(brozController.text) ?? 0.0;
            final showSummary = brozController.text.isNotEmpty && brozValue > 0;
              ...
              child: AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 6),
                          Text(
                            '• اسم العربية: ${dailyWork.selectedVehicleType ?? ''}',
                          ),
                          Text(
                            '• نولون الشركة: ${dailyWork.selectedPrice ?? 0} ج',
                          ),
                        ],
                      ),
                    ),
                    ...
                    SizedBox(height: isMobile ? 6 : 8),
                    TextFormField(
                      controller: brozController,
                      keyboardType: TextInputType.number,
                      onChanged: (value) {
                        setState(() {});
                      },
                      decoration: InputDecoration(
                        hintText: 'أدخل قيمة البروز',
                        prefixIcon: Icon(
                          Icons.attach_money,
                          color: Colors.purple[700],
                        ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 6),
                            Text('• قيمة البروز: $brozValue ج'),
                            Text(
                              '• نولون الشركة الجديد: ${(dailyWork.selectedPrice ?? 0) + brozValue} ج',
                            ),
                            Text(
                              '• اسم العربية الجديد: ${dailyWork.selectedVehicleType ?? ''} بروز',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Colors.purple[700],
                              ),
                ...
                actions: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      if (brozController.text.isEmpty) {
                        _showError('يرجى إدخال قيمة البروز');
                        return;
                      }

                      final brozValue =
                          double.tryParse(brozController.text) ?? 0.0;
                      if (brozValue <= 0) {
                        _showError('قيمة البروز يجب أن تكون أكبر من صفر');
                        return;
                      }

                      await _updateBrozOnly(dailyWork, brozValue);
                      Navigator.pop(context);
                    },
                    style: ElevatedButton.styleFrom(
  ...
  // ====================================================
  // دالة تحديث البروز فقط (نولون الشركة + اسم العربية + بروز)
  // ====================================================
  Future<void> _updateBrozOnly(DailyWork dailyWork, double brozValue) async {
    try {
      final currentPrice = dailyWork.selectedPrice ?? 0.0;
      final newPrice = currentPrice + brozValue;

      // تحديث اسم العربية بإضافة "بروز" بدون أقواس
      final currentVehicleType = dailyWork.selectedVehicleType ?? '';
      final newVehicleType = currentVehicleType.isEmpty
          ? 'بروز'
          : '$currentVehicleType بروز';

      // 1. تحديث في collection "dailyWork" - فقط نولون الشركة واسم العربية
      await _firestore.collection('dailyWork').doc(dailyWork.id).update({
        'selectedPrice': newPrice,
        'nolon': newPrice,
        'selectedVehicleType': newVehicleType,
      ...
      // 2. تحديث سجلات السائقين المرتبطة - فقط نولون الشركة واسم العربية
      final driverDocs = await _firestore
          .collection('drivers')
          .where('dailyWorkId', isEqualTo: dailyWork.id)
          .get();
      ...
      if (driverDocs.docs.isNotEmpty) {
        ...
        for (final doc in driverDocs.docs) {
          batch.update(doc.reference, {
            ...
            'selectedVehicleType': newVehicleType,
            'brozValue': brozValue,
            'remainingAmount': FieldValue.increment(brozValue),
            'updatedAt': Timestamp.now(),
          });
        }
      ...
      if (mounted && !_isDisposed) {
        _showSuccess(
          'تم إضافة بروز بقيمة $brozValue ج\nاسم العربية الجديد: $newVehicleType',
        );
      }
    } catch (e) {
      print('خطأ في تحديث البروز: $e');
      if (mounted && !_isDisposed) {
        _showError('خطأ في إضافة البروز: $e');
      }
    }
  }
...
class _TableCellActionsWithAll extends StatelessWidget {
  final DailyWork dailyWork;
  final String companyName;
  final bool isMobile;
  final VoidCallback onEdit;
  ...
  final VoidCallback onAddBroz;

  const _TableCellActionsWithAll({
    required this.dailyWork,
    required this.companyName,
    required this.isMobile,
    required this.onEdit,
