...
//       // ================================
//       // 3. حساب إجمالي الضرائب
//       // ================================
//       final taxesSnapshot = await _firestore
//           .collection('taxes')
//           .where(
//             'date',
//             isGreaterThanOrEqualTo: Timestamp.fromDate(
...
//       for (var doc in taxesSnapshot.docs) {
//         final data = doc.data();
//         totalTaxes += (data['totalTaxAmount'] ?? 0).toDouble();
//       }
...
//     final profit = company['companyProfit'] as double;
